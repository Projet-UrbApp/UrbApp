...
public class LoadExternalProjectsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (GpsGeom g :MainActivity.gpsGeom)
            Log.i(TAG,"id="+g.getGpsGeomsId()+" name = "+g.getGpsGeomCoord());
    }
        ...
        public boolean onMarkerClick(Marker marker, MapView mapView) {
            ...
            if (secondClick == firstClick) {
                ...
                for (GpsGeom gg : allGpsGeom){
                    if (refreshedValues.get(secondClick).getGpsGeom_id() == gg.getGpsGeomsId()){
    ...
    public void refreshList(){      
        ...
        Log.i(TAG,MainActivity.datasource.getDatabase().getPath());
